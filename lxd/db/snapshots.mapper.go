...
// generator: instance_snapshot GetMany
func (c *ClusterTx) GetInstanceSnapshotConfig(entity InstanceSnapshot) (map[string]string, error) {
	instance_snapshotConfig, err := c.GetConfig("instance_snapshot")
	if err != nil {
		return nil, err
	}

	config, ok := instance_snapshotConfig[entity.ID]
	if !ok {
...
// generator: instance_snapshot GetMany
func (c *ClusterTx) GetInstanceSnapshotDevices(entity InstanceSnapshot) (map[string]Device, error) {
	instance_snapshotDevices, err := c.GetDevices("instance_snapshot")
	if err != nil {
		return nil, err
	}

	devices := map[string]Device{}
	for _, ref := range instance_snapshotDevices[entity.ID] {
...
// generator: instance_snapshot Create
func (c *ClusterTx) CreateInstanceSnapshotConfig(instance_snapshotID int64, config map[string]string) error {
	referenceID := int(instance_snapshotID)
...
// generator: instance_snapshot Create
func (c *ClusterTx) CreateInstanceSnapshotDevice(instance_snapshotID int64, device Device) error {
	device.ReferenceID = int(instance_snapshotID)
