...
// generator: profile GetMany
func (c *ClusterTx) GetProfileConfig(entity Profile) (map[string]string, error) {
	profileConfig, err := c.GetConfig("profile")
	if err != nil {
		return nil, err
	}

	config, ok := profileConfig[entity.ID]
	if !ok {
...
// generator: profile GetMany
func (c *ClusterTx) GetProfileDevices(entity Profile) (map[string]Device, error) {
	...
	for _, ref := range profileDevices[entity.ID] {
