...
// generator: instance GetMany
func (c *ClusterTx) GetInstanceConfig(entity Instance) (map[string]string, error) {
	instanceConfig, err := c.GetConfig("instance")
	if err != nil {
		return nil, err
	}

	config, ok := instanceConfig[entity.ID]
	if !ok {
...
// generator: instance GetMany
func (c *ClusterTx) GetInstanceDevices(entity Instance) (map[string]Device, error) {
	...
	for _, ref := range instanceDevices[entity.ID] {
